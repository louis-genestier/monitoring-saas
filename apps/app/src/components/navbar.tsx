...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="top-0 left-0 w-screen border-b border-accent/20 h-16 flex items-center px-4 justify-start bg-white">
        <Button
      ...
      >
        ...
        >
          <div className="p-4 flex justify-between items-center">
            ...
            <Button
              variant="ghost"
              className="hover:bg-transparent hover:text-black/50"
              onClick={() => setIsOpen(false)}
            >
